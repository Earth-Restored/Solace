...
internal sealed record ActiveLocationEncounterMetadata(
    ActiveLocationEncounterMetadata.EncounterTypeE EncounterType,
    Guid LocationId,
    Guid WorldId,
    ActiveLocationEncounterMetadata.AnchorStateE AnchorState,
    string AnchorId,
