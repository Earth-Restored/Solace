...
[Migration("20260823133143_BuildplateTemplateRelation")]
partial class _20260823133143_BuildplateTemplateRelation
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Solace.Db.Earth.Models.Player.ActivityLogEntryEF", b =>
            {
                ...
                var entryId = b.Property<long>("EntryId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");

                NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(entryId);
        ...
        modelBuilder.Entity("Solace.Db.Earth.Models.Player.PlayerBuildplateEF", b =>
            {
                ...
                b.HasOne("Solace.Db.Earth.Models.Global.TemplateBuildplateEF", "Template")
                    .WithMany("PlayerBuildplates")
        ...
        modelBuilder.Entity("Solace.Db.Earth.Models.Global.TemplateBuildplateEF", b =>
            {
                b.Navigation("PlayerBuildplates");
            });
