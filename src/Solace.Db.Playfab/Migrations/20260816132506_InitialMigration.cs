    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                MaxClientVersion = table.Column<string>(type: "text", nullable: true),
                GlobalNotSearchQueryTags = table.Column<List<string>>(type: "text[]", nullable: true),
                CoinCount = table.Column<int>(type: "integer", nullable: true),
                BonusCoinCount = table.Column<int>(type: "integer", nullable: true),
                Sku = table.Column<string>(type: "text", nullable: true),
                OriginalCreatorId = table.Column<string>(type: "text", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                QueryManifestDataEFId = table.Column<Guid>(type: "uuid", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_Tabs", x => x.TabIndex);
                table.ForeignKey(
                    name: "FK_Tabs_ItemData_QueryManifestDataEFId",
                    column: x => x.QueryManifestDataEFId,
                    principalTable: "ItemData",
                    principalColumn: "Id");
            });

        migrationBuilder.CreateIndex(
            name: "IX_Tabs_QueryManifestDataEFId",
            table: "Tabs",
            column: "QueryManifestDataEFId");
