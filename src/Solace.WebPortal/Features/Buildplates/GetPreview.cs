...
)
{
          ...
          [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        if (!httpUser.HasPermission(Permissions.CreateProfile) && !httpUser.HasPermission(Permissions.ViewBuildplates) && !httpUser.HasPermission(Permissions.ViewPlayers) && !httpUser.HasPermission(Permissions.ViewStore))
        {
            yield break;
