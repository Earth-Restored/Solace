...
namespace Solace.DB.CompiledModels
{
    ...
    public partial class RewardsEntityType
    {
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var rewards = principalEntityType.AddNavigation("Rewards",
                ...
                onDependent: false,
                typeof(Rewards),
                propertyInfo: typeof(RewardedActivityLogEntryEF).GetProperty("Rewards", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RewardedActivityLogEntryEF).GetField("<Rewards>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                eagerLoaded: true);
