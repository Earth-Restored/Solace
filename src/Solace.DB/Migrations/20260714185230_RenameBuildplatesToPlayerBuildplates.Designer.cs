...
namespace Solace.DB.Postgres.Migrations
{
    ...
    [Migration("20260714185230_RenameBuildplatesToPlayerBuildplates")]
    partial class RenameBuildplatesToPlayerBuildplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solace.DB.Models.AccountVersions", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.ActivityLogEntryEF", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.BuildplateEF", b =>
                {
                    ...
                    b.ToTable("PlayerBuildplates", null, t =>
                        {
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.ItemJournalEntryEF", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.StackableItemEF", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.BoostActivatedEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.ActivityLogEntryEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.JournalItemUnlockedEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.ActivityLogEntryEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.LevelUpEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.ActivityLogEntryEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.RewardedActivityLogEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.ActivityLogEntryEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.JournalItemUnlockedTokenEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.TokenEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.RewardedTokenEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.TokenEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.CraftingCompletedEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.RewardedActivityLogEntryEF");

                    b.HasDiscriminator().HasValue("crafting_completed");
                });

            modelBuilder.Entity("Solace.DB.Models.Player.SmeltingCompletedEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.RewardedActivityLogEntryEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.TappableEntryEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.RewardedActivityLogEntryEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.DailyLoginTokenEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.RewardedTokenEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.LevelUpTokenEF", b =>
                {
                    b.HasBaseType("Solace.DB.Models.Player.RewardedTokenEF");
            ...
            modelBuilder.Entity("Solace.DB.Models.AccountVersions", b =>
                {
                    b.HasOne("Solace.DB.Models.Account", "Account")
                        ...
                        .HasForeignKey("Solace.DB.Models.AccountVersions", "Id")
            ...
            modelBuilder.Entity("Solace.DB.Models.Player.RewardedActivityLogEntryEF", b =>
                {
                    b.OwnsOne("Solace.DB.Models.Common.Rewards", "Rewards", b1 =>
                        {
